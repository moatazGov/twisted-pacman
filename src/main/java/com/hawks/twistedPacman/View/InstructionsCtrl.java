...
public class InstructionsCtrl implements Initializable {
    ...
    @FXML
    private TextArea genTxt;
    @FXML
    private TextArea arrowsTxt;
    @FXML
    private TextArea spaceTxt;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        genTxt.setText("The point of the game is to eat as much points, without getting eaten\n" +
                "by the ghosts. \nThe game ends when the player gets 200 points," +
                "or loses all their lives.");
        arrowsTxt.setText("Use the arrows to move\n" +
                "around the board");
        spaceTxt.setText("Press the space bar to blow up\n" +
        ...
        arrowsTxt.setEditable(false);
        spaceTxt.setEditable(false);
