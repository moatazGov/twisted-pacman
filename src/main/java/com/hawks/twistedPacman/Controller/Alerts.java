    ...
    public static void generateUpdateQuestionAlert(Question quesetion) {
        ...
        dialog.setResultConverter(new Callback<ButtonType, Question>() {
            ...
            public Question call(ButtonType b) {
                ...
                sysData.load();
                if (b == buttonTypeOk) {
                    Question newQuestion = new Question(quesetion.getId(), questionText.getText(), new ArrayList(List.of(answer1Text.getText(), answer2Text.getText(), answer3Text.getText(), answer4Text.getText())), answer1Text.getText(), quesetion.getDifficulty());
